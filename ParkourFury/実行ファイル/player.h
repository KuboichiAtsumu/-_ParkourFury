...
private:
	...
	void Falling(CBlock::CollisionParam aParam, CBlock::WallState wallstate);//落下中処理
	...
	void CollisionWallKick(CBlock::CollisionParam& aParam, CBlock::WallState& wallstate);//壁キック判定処理
	...
	const int DASH_FRAME = 1;//ダッシュのフレーム
	...
	const float DASH_SPEED = 20.0f;//ダッシュの速度倍率
