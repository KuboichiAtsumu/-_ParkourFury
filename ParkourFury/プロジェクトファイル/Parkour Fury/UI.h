...
public:
	...
	static CUI* Create(TYPE type, D3DXVECTOR2 pos, D3DXVECTOR2 size, D3DXVECTOR3 rot);//生成処理
	...
	//タイプ
	void SetUIType(TYPE type) { m_Type = type; }
...
private:
	...
	static constexpr const char* TEXTURE_FILE[static_cast<int>(TYPE::MAX)] =
	{
		...
		"data/TEXTURE/UI/DescriptHeat.png",//ヒートゲージ説明
		"data/TEXTURE/UI/MiniGameHead.png",//ミニゲーム見出し
		"data/TEXTURE/UI/escape.png",//チェイスエリア警告
		"",//ボスHP
		"data/TEXTURE/UI/BpssHPFrame.png",//ボスHPフレーム
	};
